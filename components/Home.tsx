      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="flex justify-center items-center mt-16 md:mt-0">
          <Image
            ...
            src="/photo3.jpg"
            alt="Tushar Jamdade's Avatar"
          />
        </div>

        {/* Intro and Typing Text */}
        <div className="flex justify-center items-center font-semibold">
          <div className="mt-6 mx-10 md:mt-0">
            <div className="text-xl mt-10">-- Hello --</div>
            ...
            <div className="flex items-center justify-center text-black dark:text-white my-8">
              <div className="flex items-center justify-center gap-x-10 md:gap-x-16">
                <Link
                  href="https://x.com/tusharnjamdade"
                  aria-label="Twitter"
                  target="_blank"
                ...
                <Link
                  href="https://github.com/Tusharjamdade"
                  aria-label="GitHub"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-4xl"
                ...
                <Link
                  href="https://www.linkedin.com/in/tusharjamdade"
                  aria-label="LinkedIn"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <Link
                  href="https://www.instagram.com/tushar_jamdade_"
            ...
            <div className="text-2xl mt-1">
              <div className="my-1 border-b text-center">
                <div className="leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white dark:bg-black transform translate-y-1/2">
                  Intro
                </div>
              </div>
